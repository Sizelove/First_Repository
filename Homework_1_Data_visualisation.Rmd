...
1.  What's gone wrong with this code? Why are the points not blue?
    ...
    Answer: The color is not a parameter for the aes function, but rather for the geom type. Moving the `color="blue"` portion of the code outside of the aes function, but within the geom function, will fix this issue.
...
2.  Which variables in `mpg` are categorical? Which variables are continuous? 
    ...
    Answer: Categorical variables in `mpg` are manufacturer, model, year, trans, drv, fl, and class. Continuous variables include     hwy, cty, cyl and displ. The second row of the output when `mpg` is run displays the variables and their types.
